...
TinyRay Studio 是一个3D计算机图形学绘图工具，用于交互式编辑简单 3D 场景、实时预览、CPU 高质量光线追踪渲染和图像导出。
该工具在**艺术创作**，**图形学教学**等领域有较大应用潜力
...
- CPU Ray Tracing
  ...
  效果展示
  <img width="1280" height="720" alt="1" src="https://github.com/user-attachments/assets/b0100d80-30f8-4475-a88f-8fa0c3f75b39" />
  <br>
